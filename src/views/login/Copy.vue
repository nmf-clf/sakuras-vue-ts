        ...
        <div class="sign-in-up">
          ...
          <!-- <form action="#" class="sign-in-form">
            ...
            <div class="form-input">
              <i>
                <svg t="1668587823260" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4804" width="20" height="20">
                  <path
            ...
            <div class="form-input">
              <i>
                <svg t="1668588609565" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5250" width="20" height="20">
                  <path
            ...
            <input type="button" class="form-btn" value="登录" @click="handleLogin"/>
            <p class="social-text">通过其他方式登录</p>
            <div class="social-media">
              <a href="#" class="social-link">
                <svg t="1668588313697" class="social-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5050" width="38" height="38">
                  <path
              ...
              <a href="#" class="social-link">
                <svg t="1668588659622" class="social-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5496" width="38" height="38">
                  <path
              ...
              <a href="#" class="social-link">
                <svg t="1668588678575" class="social-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5696" width="38" height="38">
                  <path
              ...
              <a href="#" class="social-link">
                <svg t="1668588716707" class="social-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5896" width="38" height="38">
                  <path
          ...
          <el-form 
            ...
            class="demo-ruleForm"
          >
            <el-form-item label="11" prop="pass">
              <el-input v-model="ruleForm.username" type="password" autocomplete="off" />
            </el-form-item>
            <el-form-item label="22" prop="checkPass">
              <el-input
          ...
          <!-- <form action="#" class="sign-up-form">
            ...
            <div class="form-input">
              <i>
                <svg t="1668594013934" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6569" width="20" height="20">
                  <path
              ...
              <input type="text" placeholder="邮箱" v-model="ruleForm.email" />
            </div>
            <input type="button" class="form-btn" value="注册" @click="handleRegister" />
            <p class="social-text">通过其他方式注册</p>
            <div class="social-media">
              <a href="#" class="social-link">
                <svg t="1668588313697" class="social-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5050" width="38" height="38">
                  <path
